...
func (wq *WalletQuery) QueryCommunity() *CommunityQuery {
	query := (&CommunityClient{config: wq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wq.prepareQuery(ctx); err != nil {
			return nil, err
		}
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, wallet.CommunityTable, wallet.CommunityColumn),
		)
		fromU = sqlgraph.SetNeighbors(wq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (wq *WalletQuery) QueryFromTransactions() *TransactionQuery {
	query := (&TransactionClient{config: wq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wq.prepareQuery(ctx); err != nil {
			return nil, err
		}
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, wallet.FromTransactionsTable, wallet.FromTransactionsColumn),
		)
		fromU = sqlgraph.SetNeighbors(wq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (wq *WalletQuery) QueryToTransactions() *TransactionQuery {
	query := (&TransactionClient{config: wq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wq.prepareQuery(ctx); err != nil {
			return nil, err
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(wallet.Table, wallet.FieldID, selector),
			sqlgraph.To(transaction.Table, transaction.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, wallet.ToTransactionsTable, wallet.ToTransactionsColumn),
		)
		fromU = sqlgraph.SetNeighbors(wq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (wq *WalletQuery) Clone() *WalletQuery {
	...
	return &WalletQuery{
		...
		withCommunity:        wq.withCommunity.Clone(),
		withFromTransactions: wq.withFromTransactions.Clone(),
		withToTransactions:   wq.withToTransactions.Clone(),
...
func (wq *WalletQuery) WithCommunity(opts ...func(*CommunityQuery)) *WalletQuery {
	query := (&CommunityClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wq.withCommunity = query
	return wq
}
...
func (wq *WalletQuery) WithFromTransactions(opts ...func(*TransactionQuery)) *WalletQuery {
	query := (&TransactionClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wq.withFromTransactions = query
	return wq
}
...
func (wq *WalletQuery) WithToTransactions(opts ...func(*TransactionQuery)) *WalletQuery {
	query := (&TransactionClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wq.withToTransactions = query
	return wq
}
...
func (wq *WalletQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Wallet, error) {
	var (
		...
		loadedTypes = [4]bool{
			wq.withUser != nil,
			wq.withCommunity != nil,
			wq.withFromTransactions != nil,
			wq.withToTransactions != nil,
		}
	)
	...
	if query := wq.withCommunity; query != nil {
		if err := wq.loadCommunity(ctx, query, nodes, nil,
			func(n *Wallet, e *Community) { n.Edges.Community = e }); err != nil {
			return nil, err
		}
	}
	if query := wq.withFromTransactions; query != nil {
		if err := wq.loadFromTransactions(ctx, query, nodes,
			func(n *Wallet) { n.Edges.FromTransactions = []*Transaction{} },
			func(n *Wallet, e *Transaction) { n.Edges.FromTransactions = append(n.Edges.FromTransactions, e) }); err != nil {
			return nil, err
		}
	}
	if query := wq.withToTransactions; query != nil {
		if err := wq.loadToTransactions(ctx, query, nodes,
			func(n *Wallet) { n.Edges.ToTransactions = []*Transaction{} },
			func(n *Wallet, e *Transaction) { n.Edges.ToTransactions = append(n.Edges.ToTransactions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (wq *WalletQuery) loadCommunity(ctx context.Context, query *CommunityQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *Community)) error {
...
func (wq *WalletQuery) loadFromTransactions(ctx context.Context, query *TransactionQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *Transaction)) error {
	...
	query.Where(predicate.Transaction(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(wallet.FromTransactionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (wq *WalletQuery) loadToTransactions(ctx context.Context, query *TransactionQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *Transaction)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Wallet)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Transaction(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(wallet.ToTransactionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (wq *WalletQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := wq.ctx.Fields; len(fields) > 0 {
		...
		if wq.withCommunity != nil {
			_spec.Node.AddColumnOnce(wallet.FieldCommunityID)
		}
	}
