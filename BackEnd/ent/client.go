...
import (
	...
	"suwasystem/backend/ent/migrate"
...
// QueryWallets queries the wallets edge of a Community.
func (c *CommunityClient) QueryWallets(co *Community) *WalletQuery {
...
// QueryOwner queries the owner edge of a Community.
func (c *CommunityClient) QueryOwner(co *Community) *UserQuery {
...
// QueryFromTransactions queries the from_transactions edge of a Community.
func (c *CommunityClient) QueryFromTransactions(co *Community) *TransactionQuery {
...
// QueryToTransactions queries the to_transactions edge of a Community.
func (c *CommunityClient) QueryToTransactions(co *Community) *TransactionQuery {
	query := (&TransactionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := co.ID
		step := sqlgraph.NewStep(
...
// QueryFromCommunity queries the from_community edge of a Transaction.
func (c *TransactionClient) QueryFromCommunity(t *Transaction) *CommunityQuery {
...
// QueryToCommunity queries the to_community edge of a Transaction.
func (c *TransactionClient) QueryToCommunity(t *Transaction) *CommunityQuery {
	query := (&CommunityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
...
// QueryFromWallet queries the from_wallet edge of a Transaction.
func (c *TransactionClient) QueryFromWallet(t *Transaction) *WalletQuery {
	query := (&WalletClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
...
// QueryToWallet queries the to_wallet edge of a Transaction.
func (c *TransactionClient) QueryToWallet(t *Transaction) *WalletQuery {
	query := (&WalletClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
...
// QueryOwnerCommunities queries the owner_communities edge of a User.
func (c *UserClient) QueryOwnerCommunities(u *User) *CommunityQuery {
	query := (&CommunityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(community.Table, community.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.OwnerCommunitiesTable, user.OwnerCommunitiesColumn),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryCommunity queries the community edge of a Wallet.
func (c *WalletClient) QueryCommunity(w *Wallet) *CommunityQuery {
	query := (&CommunityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := w.ID
		step := sqlgraph.NewStep(
...
// QueryFromTransactions queries the from_transactions edge of a Wallet.
func (c *WalletClient) QueryFromTransactions(w *Wallet) *TransactionQuery {
	query := (&TransactionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := w.ID
		step := sqlgraph.NewStep(
...
// QueryToTransactions queries the to_transactions edge of a Wallet.
func (c *WalletClient) QueryToTransactions(w *Wallet) *TransactionQuery {
	query := (&TransactionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := w.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		Community, Transaction, User, Wallet []ent.Hook
	}
	inters struct {
		Community, Transaction, User, Wallet []ent.Interceptor
	}
)
